  ...
  `SELECT
     ...
     ROUND(
       COALESCE(
         SUM(
           CASE
             WHEN DATE(date_created_gmt) = UTC_DATE()
             THEN total_amount
             ELSE 0
           END
         ),
